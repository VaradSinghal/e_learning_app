...
import 'package:e_learning_app/views/quiz/quiz_attempt/widgets/quiz_attempt_app_bar.dart';
import 'package:e_learning_app/views/quiz/quiz_attempt/widgets/quiz_navigation_bar.dart';
import 'package:e_learning_app/views/quiz/quiz_attempt/widgets/quiz_question_page.dart';
import 'package:e_learning_app/views/quiz/quiz_attempt/widgets/quiz_submit_dialog.dart';
...
class _QuizAttemptScreenState extends State<QuizAttemptScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemBuilder:
            (context, index) => QuizQuestionPage(
              questionNmber: index + 1,
  ...
  Future<void> _showSubmitDialog(BuildContext context) async {
    ...
    return showDialog(
      ...
      builder:
          (context) => QuizSubmitDialog(attempt: currentAttempt!, quiz: quiz),
    );
  }
}
